...
`, Zo = (e, t) => {
  ...
  for (const [s, i] of t)
    n[s] = i;
  return n;
}, Jo = /* @__PURE__ */ _o('<div class="column" style="justify-self:start;"> top-left </div><div class="column" style="justify-self:end;"> top-right </div><div class="column content" style=""><h1>Streaming satellites a la Mirona</h1></div><div class="column" style="justify-self:start;align-self:end;"> bottom-left </div><div class="column" style="justify-self:end;align-self:end;"><button class="btn">Comprar entrades</button></div>', 5), Qo = [
  Jo
